...
architecture STRUCTURE of btn_led_wrapper is
  ...
  end component btn_led;
begin
btn_led_i: component btn_led
     port map (
      button_pin_tri_i(0) => button_pin_tri_i(0),
      ...
      led_pin_tri_o(1 downto 0) => led_pin_tri_o(1 downto 0),
      reset => reset,
      sys_clock => sys_clock,
