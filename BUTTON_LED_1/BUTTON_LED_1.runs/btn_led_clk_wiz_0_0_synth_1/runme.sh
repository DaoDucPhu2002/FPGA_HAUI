...
HD_PWD='D:/CODE/FPGA/BUTTON_LED_1/BUTTON_LED_1.runs/btn_led_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_led_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source btn_led_clk_wiz_0_0.tcl
