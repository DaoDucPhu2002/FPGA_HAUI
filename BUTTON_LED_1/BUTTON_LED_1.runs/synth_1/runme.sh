...
HD_PWD='D:/CODE/FPGA/BUTTON_LED_1/BUTTON_LED_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source btn_led_wrapper.tcl
