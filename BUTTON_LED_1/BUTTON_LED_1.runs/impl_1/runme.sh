...
HD_PWD='D:/CODE/FPGA/BUTTON_LED_1/BUTTON_LED_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source btn_led_wrapper.tcl -notrace
