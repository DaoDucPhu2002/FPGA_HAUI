...
--Command     : generate_target rgb_design_wrapper.bd
...
end rgb_design_wrapper;

architecture STRUCTURE of rgb_design_wrapper is
  component rgb_design is
  port (
    sys_clock : in STD_LOGIC;
    ddr3_sdram_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
    ddr3_sdram_dqs_p : inout STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component rgb_design;
begin
rgb_design_i: component rgb_design
     port map (
      ...
      led_rgb_tri_o(2 downto 0) => led_rgb_tri_o(2 downto 0),
      reset => reset,
      sys_clock => sys_clock,
