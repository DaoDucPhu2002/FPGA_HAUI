...
HD_PWD='D:/CODE/FPGA/RGB/RGB.runs/rgb_design_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_design_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb_design_mdm_1_0.tcl
