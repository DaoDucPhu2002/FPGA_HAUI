...
HD_PWD='D:/CODE/FPGA/RGB/RGB.runs/rgb_design_rst_mig_7series_0_83M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_design_rst_mig_7series_0_83M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb_design_rst_mig_7series_0_83M_0.tcl
