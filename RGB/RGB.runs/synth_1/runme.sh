...
HD_PWD='D:/CODE/FPGA/RGB/RGB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb_design_wrapper.tcl
