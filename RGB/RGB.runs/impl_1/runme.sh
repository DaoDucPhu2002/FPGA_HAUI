...
HD_PWD='D:/CODE/FPGA/RGB/RGB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rgb_design_wrapper.tcl -notrace
