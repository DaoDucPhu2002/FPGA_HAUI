...
HD_PWD='D:/CODE/FPGA/BTTH/Bai/Bai.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw4_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw4_wrapper.tcl
