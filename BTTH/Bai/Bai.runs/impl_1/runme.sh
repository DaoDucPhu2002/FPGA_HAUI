...
HD_PWD='D:/CODE/FPGA/BTTH/Bai/Bai.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw4_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw4_wrapper.tcl -notrace
