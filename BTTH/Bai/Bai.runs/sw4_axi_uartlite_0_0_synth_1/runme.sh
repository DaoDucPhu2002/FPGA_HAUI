...
HD_PWD='D:/CODE/FPGA/BTTH/Bai/Bai.runs/sw4_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw4_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw4_axi_uartlite_0_0.tcl
