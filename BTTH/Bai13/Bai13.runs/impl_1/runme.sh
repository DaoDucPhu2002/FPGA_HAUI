...
HD_PWD='D:/CODE/FPGA/BTTH/Bai13/Bai13.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bai13_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bai13_wrapper.tcl -notrace
