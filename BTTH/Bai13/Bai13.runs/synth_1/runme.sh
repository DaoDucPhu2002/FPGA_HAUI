...
HD_PWD='D:/CODE/FPGA/BTTH/Bai13/Bai13.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bai13_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bai13_wrapper.tcl
