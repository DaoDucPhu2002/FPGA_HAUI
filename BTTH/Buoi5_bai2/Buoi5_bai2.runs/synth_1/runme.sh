...
HD_PWD='D:/CODE/FPGA/BTTH/Buoi5_bai2/Buoi5_bai2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BTN_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BTN_1_wrapper.tcl
