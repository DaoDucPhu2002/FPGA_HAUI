...
HD_PWD='D:/CODE/FPGA/BTTH/Buoi5_bai2/Buoi5_bai2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BTN_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BTN_1_wrapper.tcl -notrace
