...
--Command     : generate_target BTN_1_wrapper.bd
...
architecture STRUCTURE of BTN_1_wrapper is
  component BTN_1 is
  port (
    sys_clock : in STD_LOGIC;
    ddr3_sdram_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
...
BTN_1_i: component BTN_1
     port map (
      ...
      gpio_rtl_tri_i(0) => gpio_rtl_tri_i(0),
      reset => reset,
      sys_clock => sys_clock,
