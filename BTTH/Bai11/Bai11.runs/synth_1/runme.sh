...
HD_PWD='D:/CODE/FPGA/BTTH/Bai11/Bai11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bai11_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bai11_wrapper.tcl
