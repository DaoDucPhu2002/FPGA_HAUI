...
HD_PWD='D:/CODE/FPGA/BTTH/Bai11/Bai11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bai11_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bai11_wrapper.tcl -notrace
