...
HD_PWD='D:/CODE/FPGA/BTTH/Bai9/Bai9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BTN_LED_don_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BTN_LED_don_wrapper.tcl -notrace
