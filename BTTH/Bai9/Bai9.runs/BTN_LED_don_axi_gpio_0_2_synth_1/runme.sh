...
HD_PWD='D:/CODE/FPGA/BTTH/Bai9/Bai9.runs/BTN_LED_don_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BTN_LED_don_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BTN_LED_don_axi_gpio_0_2.tcl
