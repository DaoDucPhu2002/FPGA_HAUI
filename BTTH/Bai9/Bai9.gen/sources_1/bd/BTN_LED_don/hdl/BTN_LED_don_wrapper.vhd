...
--Command     : generate_target BTN_LED_don_wrapper.bd
--Design      : BTN_LED_don_wrapper
...
end BTN_LED_don_wrapper;

architecture STRUCTURE of BTN_LED_don_wrapper is
  component BTN_LED_don is
  port (
    ddr3_sdram_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
    ddr3_sdram_dqs_p : inout STD_LOGIC_VECTOR ( 1 downto 0 );
    ddr3_sdram_dqs_n : inout STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component BTN_LED_don;
begin
BTN_LED_don_i: component BTN_LED_don
     port map (
      btn_pin_tri_i(3 downto 0) => btn_pin_tri_i(3 downto 0),
      ...
      led_pin_tri_o(3 downto 0) => led_pin_tri_o(3 downto 0),
      reset => reset,
      sys_clock => sys_clock,
