...
HD_PWD='D:/CODE/FPGA/BTTH/Bai1/Bai1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BAI1_4LED_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BAI1_4LED_wrapper.tcl -notrace
