...
HD_PWD='D:/CODE/FPGA/BTTH/Bai1/Bai1.runs/BAI1_4LED_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BAI1_4LED_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BAI1_4LED_lmb_bram_0.tcl
