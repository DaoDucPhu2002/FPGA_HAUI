...
HD_PWD='D:/CODE/FPGA/BTTH/Bai6/Bai6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bai6_4sw_4led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bai6_4sw_4led_wrapper.tcl
