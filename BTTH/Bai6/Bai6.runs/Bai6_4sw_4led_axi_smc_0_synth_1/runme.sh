...
HD_PWD='D:/CODE/FPGA/BTTH/Bai6/Bai6.runs/Bai6_4sw_4led_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bai6_4sw_4led_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bai6_4sw_4led_axi_smc_0.tcl
