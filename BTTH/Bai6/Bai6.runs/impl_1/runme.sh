...
HD_PWD='D:/CODE/FPGA/BTTH/Bai6/Bai6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bai6_4sw_4led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bai6_4sw_4led_wrapper.tcl -notrace
