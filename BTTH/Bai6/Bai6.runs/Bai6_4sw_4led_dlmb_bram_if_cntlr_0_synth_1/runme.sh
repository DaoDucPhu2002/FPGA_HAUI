...
HD_PWD='D:/CODE/FPGA/BTTH/Bai6/Bai6.runs/Bai6_4sw_4led_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bai6_4sw_4led_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bai6_4sw_4led_dlmb_bram_if_cntlr_0.tcl
