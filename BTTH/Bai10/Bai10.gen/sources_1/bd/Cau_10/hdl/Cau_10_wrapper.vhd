...
--Command     : generate_target Cau_10_wrapper.bd
...
architecture STRUCTURE of Cau_10_wrapper is
  component Cau_10 is
  port (
    ddr3_sdram_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
    ddr3_sdram_dqs_p : inout STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  end component Cau_10;
begin
Cau_10_i: component Cau_10
     port map (
