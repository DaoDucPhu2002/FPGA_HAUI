...
HD_PWD='D:/CODE/FPGA/BTTH/Bai10/Bai10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cau_10_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cau_10_wrapper.tcl
