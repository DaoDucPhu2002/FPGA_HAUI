...
HD_PWD='D:/CODE/FPGA/BTTH/Bai10/Bai10.runs/Cau_10_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cau_10_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cau_10_ilmb_bram_if_cntlr_0.tcl
