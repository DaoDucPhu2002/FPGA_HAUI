...
HD_PWD='D:/CODE/FPGA/BTTH/Bai10/Bai10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Cau_10_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cau_10_wrapper.tcl -notrace
