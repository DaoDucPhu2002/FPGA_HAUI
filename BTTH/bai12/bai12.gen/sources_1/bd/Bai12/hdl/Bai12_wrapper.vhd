...
--Date        : Wed Oct 18 09:50:29 2023
--Host        : Dao_Duc_Phu running 64-bit major release  (build 9200)
--Command     : generate_target Bai12_wrapper.bd
--Design      : Bai12_wrapper
...
architecture STRUCTURE of Bai12_wrapper is
  component Bai12 is
  port (
    sys_clock : in STD_LOGIC;
    ddr3_sdram_dq : inout STD_LOGIC_VECTOR ( 15 downto 0 );
...
Bai12_i: component Bai12
     port map (
      ...
      gpb_pin_tri_o(2 downto 0) => gpb_pin_tri_o(2 downto 0),
      reset => reset,
      sys_clock => sys_clock,
