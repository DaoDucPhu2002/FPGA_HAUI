...
HD_PWD='D:/CODE/FPGA/BTTH/bai12/bai12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bai12_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bai12_wrapper.tcl -notrace
