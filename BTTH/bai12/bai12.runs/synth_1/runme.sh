...
HD_PWD='D:/CODE/FPGA/BTTH/bai12/bai12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bai12_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bai12_wrapper.tcl
