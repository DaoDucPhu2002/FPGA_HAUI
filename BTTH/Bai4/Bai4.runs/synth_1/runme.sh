...
HD_PWD='D:/CODE/FPGA/BTTH/Bai4/Bai4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BAI4_4RGB_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BAI4_4RGB_wrapper.tcl
