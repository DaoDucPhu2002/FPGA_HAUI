...
HD_PWD='D:/CODE/FPGA/BTTH/Bai4/Bai4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BAI4_4RGB_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BAI4_4RGB_wrapper.tcl -notrace
