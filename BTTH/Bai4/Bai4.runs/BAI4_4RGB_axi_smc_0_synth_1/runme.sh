...
HD_PWD='D:/CODE/FPGA/BTTH/Bai4/Bai4.runs/BAI4_4RGB_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BAI4_4RGB_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BAI4_4RGB_axi_smc_0.tcl
