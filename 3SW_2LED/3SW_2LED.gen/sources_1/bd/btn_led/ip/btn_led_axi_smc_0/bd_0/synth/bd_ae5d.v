...
//--------------------------------------------------------------------------------
//Command: generate_target bd_ae5d.bd
//Design : bd_ae5d
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* core_generation_info = "bd_ae5d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_ae5d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=37,numReposBlks=29,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* hw_handoff = "btn_led_axi_smc_0.hwdef" *) 
module bd_ae5d
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  (* x_interface_info = "xilinx.com:interface:aximm:1.0 S00_AXI ARADDR" *) (* x_interface_parameter = "XIL_INTERFACENAME S00_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN btn_led_mig_7series_0_0_ui_clk, DATA_WIDTH 32, FREQ_HZ 83333333, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 4, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 32, NUM_WRITE_THREADS 1, PHASE 0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]S00_AXI_araddr;
  ...
  (* x_interface_info = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* x_interface_parameter = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:S00_AXI:S01_AXI, ASSOCIATED_CLKEN m_sc_aclken, CLK_DOMAIN btn_led_mig_7series_0_0_ui_clk, FREQ_HZ 83333333, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) input aclk;
  ...
  m00_exit_pipeline_imp_1WDS457 m00_exit_pipeline
  ...
  m00_nodes_imp_1A4OT7B m00_nodes
  ...
  s00_entry_pipeline_imp_WKBB3S s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_QVTVXE s00_nodes
  ...
  s01_entry_pipeline_imp_1U35358 s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_1YGC51W s01_nodes
  ...
  switchboards_imp_32NGFQ switchboards
...
module m00_exit_pipeline_imp_1WDS457
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module s00_entry_pipeline_imp_WKBB3S
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_ae5d_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_ae5d_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_ae5d_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module s01_entry_pipeline_imp_1U35358
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_ae5d_s01mmu_0 s01_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_rresp(s_axi_1_RRESP),
        .s_axi_rvalid(s_axi_1_RVALID));
  bd_ae5d_s01sic_0 s01_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_ae5d_s01tr_0 s01_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module switchboards_imp_32NGFQ
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
