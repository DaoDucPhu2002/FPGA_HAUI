...
HD_PWD='D:/CODE/FPGA/3SW_2LED/3SW_2LED.runs/btn_led_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_led_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source btn_led_ilmb_bram_if_cntlr_0.tcl
